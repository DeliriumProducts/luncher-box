...
Всеки ресторант ще заплаща месечен абонамент към нашата платформа. В замяна на това, те ще получат достъп до напълно персонализирано меню + админ панел. При поставянето на поръчка, клиентът ще бъде помолен да извърши плащане или чрез кредитна/дебитна карта, в брой или с криптовалута, предотвратявайки експлоатация от външни клиенти. 
