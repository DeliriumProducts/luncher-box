...
CREATE TABLE `order` (
  ...
  CONSTRAINT `FK_a9757413db9333d4bb21a2a42aa` FOREIGN KEY (`tableId`) REFERENCES `table` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `order_product` (
  ...
  CONSTRAINT `FK_073c85ed133e05241040bd70f02` FOREIGN KEY (`productId`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_3fb066240db56c9558a91139431` FOREIGN KEY (`orderId`) REFERENCES `order` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `table` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `IDX_2cb0b78846e0a65d35a4cd02d3` (`name`)
